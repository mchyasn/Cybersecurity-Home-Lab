...
def differential_testing(xml_file, business, asset_type, asset_value):
    ...
    main_dir = os.path.join(base_output_dir, business, asset_type, asset_value,
                            "WEBENVFINAL", "Advanced Topics", "host-header", "Techniques", "Differential")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Differential Testing Scanner")
    ...
    differential_testing(args.xml_file, args.business, args.asset_type, args.asset_value)
